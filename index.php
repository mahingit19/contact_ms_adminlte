                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div id="donut-chart" style="height: 300px; padding: 0px; position: relative;"><canvas
                                        class="flot-base" width="1297" height="450"
                                        style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 865px; height: 300px;"></canvas><canvas
                                        class="flot-overlay" width="1297" height="450"
                                        style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 865px; height: 300px;"></canvas><span
                                        class="pieLabel" id="pieLabel0"
                                        style="position: absolute; top: 70.5px; left: 491px;">
                                        <div
                                            style="font-size:13px; text-align:center; padding:2px; color: #fff; font-weight: 600;">
                                            Series2<br>30%</div>
                                    </span><span class="pieLabel" id="pieLabel1"
                                        style="position: absolute; top: 210.5px; left: 469px;">
                                        <div
                                            style="font-size:13px; text-align:center; padding:2px; color: #fff; font-weight: 600;">
                                            Series3<br>20%</div>
                                    </span><span class="pieLabel" id="pieLabel2"
                                        style="position: absolute; top: 129.5px; left: 310px;">
                                        <div
                                            style="font-size:13px; text-align:center; padding:2px; color: #fff; font-weight: 600;">
                                            Series4<br>50%</div>
                                    </span></div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                <canvas id="pieChart" style="height: 446px; width: 893px;" width="1339" height="669"></canvas>
                            </div>
                            <!-- /.box-body -->
                        </div>
                    </div>
